...
const House = ({ house }) => {
  const { image, type, country, address, bedrooms, bathrooms, surface, price } =
    house;
  return (
    <div className="bg-white shadow-1 p-5 rounded-lg  w-full max-w-[352px] mx-auto  rounded-tl-[90px]  cursor-pointer hover:shadow-2xl transition h-full">
      <img
        className="mb-8 rounded-tl-[90px] rounded-br-[90px] h-[250px] w-full"
        src={image}
        alt=""
      />
